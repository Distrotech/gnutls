 ...
 */
static char const p11tool_opt_strs[3760] =
/*     0 */ "p11tool @VERSION@\n"
            "Copyright (C) 2000-@YEAR@ Free Software Foundation, and others, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
...
/*  1505 */ "an alias for the 'list-all-privkeys' option\0"
/*  1549 */ "list-privkeys\0"
/*  1563 */ "list-keys\0"
/*  1573 */ "List all available certificates marked as trusted\0"
/*  1623 */ "LIST_ALL_TRUSTED\0"
/*  1640 */ "list-all-trusted\0"
/*  1657 */ "Initializes a PKCS #11 token\0"
/*  1686 */ "INITIALIZE\0"
/*  1697 */ "initialize\0"
/*  1708 */ "Writes the loaded objects to a PKCS #11 token\0"
/*  1754 */ "WRITE\0"
/*  1760 */ "write\0"
/*  1766 */ "Deletes the objects matching the PKCS #11 URL\0"
/*  1812 */ "DELETE\0"
/*  1819 */ "delete\0"
/*  1826 */ "Generate random data\0"
/*  1847 */ "GENERATE_RANDOM\0"
/*  1863 */ "generate-random\0"
/*  1879 */ "Generate an RSA private-public key pair\0"
/*  1919 */ "GENERATE_RSA\0"
/*  1932 */ "generate-rsa\0"
/*  1945 */ "GENERATE_DSA\0"
/*  1958 */ "generate-dsa\0"
/*  1971 */ "GENERATE_ECC\0"
/*  1984 */ "generate-ecc\0"
/*  1997 */ "Sets a label for the write operation\0"
/*  2034 */ "LABEL\0"
/*  2040 */ "label\0"
/*  2046 */ "Marks the object to be written as trusted\0"
/*  2088 */ "TRUSTED\0"
/*  2096 */ "no-trusted\0"
/*  2107 */ "no\0"
/*  2110 */ "Marks the object to be written as private\0"
/*  2152 */ "PRIVATE\0"
/*  2160 */ "no-private\0"
/*  2171 */ "Force (user) login to token\0"
/*  2199 */ "LOGIN\0"
/*  2205 */ "no-login\0"
/*  2214 */ "Force security officer login to token\0"
/*  2252 */ "SO_LOGIN\0"
/*  2261 */ "no-so-login\0"
/*  2273 */ "an alias for the 'so-login' option\0"
/*  2308 */ "admin-login\0"
/*  2320 */ "Print detailed URLs\0"
/*  2340 */ "DETAILED_URL\0"
/*  2353 */ "no-detailed-url\0"
/*  2369 */ "Provide a hex encoded secret key\0"
/*  2402 */ "SECRET_KEY\0"
/*  2413 */ "secret-key\0"
/*  2424 */ "Private key file to use\0"
/*  2448 */ "LOAD_PRIVKEY\0"
/*  2461 */ "load-privkey\0"
/*  2474 */ "Public key file to use\0"
/*  2497 */ "LOAD_PUBKEY\0"
/*  2509 */ "load-pubkey\0"
/*  2521 */ "Certificate file to use\0"
/*  2545 */ "LOAD_CERTIFICATE\0"
/*  2562 */ "load-certificate\0"
/*  2579 */ "Use PKCS #8 format for private keys\0"
/*  2615 */ "PKCS8\0"
/*  2621 */ "pkcs8\0"
/*  2627 */ "Specify the number of bits for key generate\0"
/*  2671 */ "BITS\0"
/*  2676 */ "bits\0"
/*  2681 */ "Specify the security level\0"
/*  2708 */ "SEC_PARAM\0"
/*  2718 */ "sec-param\0"
/*  2728 */ "Use DER/RAW format for input\0"
/*  2757 */ "INDER\0"
/*  2763 */ "no-inder\0"
/*  2772 */ "an alias for the 'inder' option\0"
/*  2804 */ "inraw\0"
/*  2810 */ "Use DER format for output certificates, private keys, and DH parameters\0"
/*  2882 */ "OUTDER\0"
/*  2889 */ "no-outder\0"
/*  2899 */ "an alias for the 'outder' option\0"
/*  2932 */ "outraw\0"
/*  2939 */ "Specify the PKCS #11 provider library\0"
/*  2977 */ "PROVIDER\0"
/*  2986 */ "provider\0"
/*  2995 */ "display extended usage information and exit\0"
/*  3039 */ "help\0"
/*  3044 */ "extended usage information passed thru pager\0"
/*  3089 */ "more-help\0"
/*  3099 */ "output version information and exit\0"
/*  3135 */ "version\0"
/*  3143 */ "P11TOOL\0"
/*  3151 */ "p11tool - GnuTLS PKCS #11 tool\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [url]\n\0"
/*  3246 */ "@PACKAGE_BUGREPORT@\0"
/*  3266 */ "\n\0"
/*  3268 */ "Program that allows handling data from PKCS #11 smart cards and security\n"
            "modules.\n\n"
            ...
            "variable GNUTLS_PIN.\n\0"
/*  3678 */ "p11tool @VERSION@\0"
/*  3696 */ "p11tool [options] [url]\n"
...
#define LIST_PRIVKEYS_DESC    (p11tool_opt_strs+1505)
#define LIST_PRIVKEYS_NAME    NULL
/** Unmodified name string for the list-privkeys option */
#define LIST_PRIVKEYS_name    (p11tool_opt_strs+1549)
...
#define LIST_KEYS_DESC    (p11tool_opt_strs+1505)
#define LIST_KEYS_NAME    NULL
/** Unmodified name string for the list-keys option */
#define LIST_KEYS_name    (p11tool_opt_strs+1563)
...
#define LIST_ALL_TRUSTED_DESC      (p11tool_opt_strs+1573)
/** Upper-cased name for the list-all-trusted option */
#define LIST_ALL_TRUSTED_NAME      (p11tool_opt_strs+1623)
/** Name string for the list-all-trusted option */
#define LIST_ALL_TRUSTED_name      (p11tool_opt_strs+1640)
...
#define INITIALIZE_DESC      (p11tool_opt_strs+1657)
/** Upper-cased name for the initialize option */
#define INITIALIZE_NAME      (p11tool_opt_strs+1686)
/** Name string for the initialize option */
#define INITIALIZE_name      (p11tool_opt_strs+1697)
...
#define WRITE_DESC      (p11tool_opt_strs+1708)
/** Upper-cased name for the write option */
#define WRITE_NAME      (p11tool_opt_strs+1754)
/** Name string for the write option */
#define WRITE_name      (p11tool_opt_strs+1760)
...
#define DELETE_DESC      (p11tool_opt_strs+1766)
/** Upper-cased name for the delete option */
#define DELETE_NAME      (p11tool_opt_strs+1812)
/** Name string for the delete option */
#define DELETE_name      (p11tool_opt_strs+1819)
...
#define GENERATE_RANDOM_DESC      (p11tool_opt_strs+1826)
/** Upper-cased name for the generate-random option */
#define GENERATE_RANDOM_NAME      (p11tool_opt_strs+1847)
/** Name string for the generate-random option */
#define GENERATE_RANDOM_name      (p11tool_opt_strs+1863)
...
#define GENERATE_RSA_DESC      (p11tool_opt_strs+1879)
/** Upper-cased name for the generate-rsa option */
#define GENERATE_RSA_NAME      (p11tool_opt_strs+1919)
/** Name string for the generate-rsa option */
#define GENERATE_RSA_name      (p11tool_opt_strs+1932)
...
#define GENERATE_DSA_DESC      (p11tool_opt_strs+1879)
/** Upper-cased name for the generate-dsa option */
#define GENERATE_DSA_NAME      (p11tool_opt_strs+1945)
/** Name string for the generate-dsa option */
#define GENERATE_DSA_name      (p11tool_opt_strs+1958)
...
#define GENERATE_ECC_DESC      (p11tool_opt_strs+1879)
/** Upper-cased name for the generate-ecc option */
#define GENERATE_ECC_NAME      (p11tool_opt_strs+1971)
/** Name string for the generate-ecc option */
#define GENERATE_ECC_name      (p11tool_opt_strs+1984)
...
#define LABEL_DESC      (p11tool_opt_strs+1997)
/** Upper-cased name for the label option */
#define LABEL_NAME      (p11tool_opt_strs+2034)
/** Name string for the label option */
#define LABEL_name      (p11tool_opt_strs+2040)
...
#define TRUSTED_DESC      (p11tool_opt_strs+2046)
/** Upper-cased name for the trusted option */
#define TRUSTED_NAME      (p11tool_opt_strs+2088)
/** disablement name for the trusted option */
#define NOT_TRUSTED_name  (p11tool_opt_strs+2096)
/** disablement prefix for the trusted option */
#define NOT_TRUSTED_PFX   (p11tool_opt_strs+2107)
...
#define PRIVATE_DESC      (p11tool_opt_strs+2110)
/** Upper-cased name for the private option */
#define PRIVATE_NAME      (p11tool_opt_strs+2152)
/** disablement name for the private option */
#define NOT_PRIVATE_name  (p11tool_opt_strs+2160)
/** disablement prefix for the private option */
#define NOT_PRIVATE_PFX   (p11tool_opt_strs+2107)
...
#define LOGIN_DESC      (p11tool_opt_strs+2171)
/** Upper-cased name for the login option */
#define LOGIN_NAME      (p11tool_opt_strs+2199)
/** disablement name for the login option */
#define NOT_LOGIN_name  (p11tool_opt_strs+2205)
/** disablement prefix for the login option */
#define NOT_LOGIN_PFX   (p11tool_opt_strs+2107)
...
#define SO_LOGIN_DESC      (p11tool_opt_strs+2214)
/** Upper-cased name for the so-login option */
#define SO_LOGIN_NAME      (p11tool_opt_strs+2252)
/** disablement name for the so-login option */
#define NOT_SO_LOGIN_name  (p11tool_opt_strs+2261)
/** disablement prefix for the so-login option */
#define NOT_SO_LOGIN_PFX   (p11tool_opt_strs+2107)
...
#define ADMIN_LOGIN_DESC    (p11tool_opt_strs+2273)
#define ADMIN_LOGIN_NAME    NULL
/** Unmodified name string for the admin-login option */
#define ADMIN_LOGIN_name    (p11tool_opt_strs+2308)
...
#define DETAILED_URL_DESC      (p11tool_opt_strs+2320)
/** Upper-cased name for the detailed-url option */
#define DETAILED_URL_NAME      (p11tool_opt_strs+2340)
/** disablement name for the detailed-url option */
#define NOT_DETAILED_URL_name  (p11tool_opt_strs+2353)
/** disablement prefix for the detailed-url option */
#define NOT_DETAILED_URL_PFX   (p11tool_opt_strs+2107)
...
#define SECRET_KEY_DESC      (p11tool_opt_strs+2369)
/** Upper-cased name for the secret-key option */
#define SECRET_KEY_NAME      (p11tool_opt_strs+2402)
/** Name string for the secret-key option */
#define SECRET_KEY_name      (p11tool_opt_strs+2413)
...
#define LOAD_PRIVKEY_DESC      (p11tool_opt_strs+2424)
/** Upper-cased name for the load-privkey option */
#define LOAD_PRIVKEY_NAME      (p11tool_opt_strs+2448)
/** Name string for the load-privkey option */
#define LOAD_PRIVKEY_name      (p11tool_opt_strs+2461)
...
#define LOAD_PUBKEY_DESC      (p11tool_opt_strs+2474)
/** Upper-cased name for the load-pubkey option */
#define LOAD_PUBKEY_NAME      (p11tool_opt_strs+2497)
/** Name string for the load-pubkey option */
#define LOAD_PUBKEY_name      (p11tool_opt_strs+2509)
...
#define LOAD_CERTIFICATE_DESC      (p11tool_opt_strs+2521)
/** Upper-cased name for the load-certificate option */
#define LOAD_CERTIFICATE_NAME      (p11tool_opt_strs+2545)
/** Name string for the load-certificate option */
#define LOAD_CERTIFICATE_name      (p11tool_opt_strs+2562)
...
#define PKCS8_DESC      (p11tool_opt_strs+2579)
/** Upper-cased name for the pkcs8 option */
#define PKCS8_NAME      (p11tool_opt_strs+2615)
/** Name string for the pkcs8 option */
#define PKCS8_name      (p11tool_opt_strs+2621)
...
#define SEC_PARAM_DESC      (p11tool_opt_strs+2681)
/** Upper-cased name for the sec-param option */
#define SEC_PARAM_NAME      (p11tool_opt_strs+2708)
...
#define INDER_DESC      (p11tool_opt_strs+2728)
/** Upper-cased name for the inder option */
#define INDER_NAME      (p11tool_opt_strs+2757)
/** disablement name for the inder option */
#define NOT_INDER_name  (p11tool_opt_strs+2763)
/** disablement prefix for the inder option */
#define NOT_INDER_PFX   (p11tool_opt_strs+2107)
...
#define INRAW_DESC    (p11tool_opt_strs+2772)
#define INRAW_NAME    NULL
/** Unmodified name string for the inraw option */
#define INRAW_name    (p11tool_opt_strs+2804)
...
#define OUTDER_DESC      (p11tool_opt_strs+2810)
/** Upper-cased name for the outder option */
#define OUTDER_NAME      (p11tool_opt_strs+2882)
/** disablement name for the outder option */
#define NOT_OUTDER_name  (p11tool_opt_strs+2889)
/** disablement prefix for the outder option */
#define NOT_OUTDER_PFX   (p11tool_opt_strs+2107)
...
#define OUTRAW_DESC    (p11tool_opt_strs+2899)
#define OUTRAW_NAME    NULL
/** Unmodified name string for the outraw option */
#define OUTRAW_name    (p11tool_opt_strs+2932)
...
#define PROVIDER_DESC      (p11tool_opt_strs+2939)
/** Upper-cased name for the provider option */
#define PROVIDER_NAME      (p11tool_opt_strs+2977)
/** Name string for the provider option */
#define PROVIDER_name      (p11tool_opt_strs+2986)
 ...
 */
#define HELP_DESC       (p11tool_opt_strs+2995)
#define HELP_name       (p11tool_opt_strs+3039)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (p11tool_opt_strs+3044)
#define MORE_HELP_name  (p11tool_opt_strs+3089)
...
#endif
#define VER_DESC        (p11tool_opt_strs+3099)
#define VER_name        (p11tool_opt_strs+3135)
/**
...
#define zPROGNAME       (p11tool_opt_strs+3143)
/** Reference to the title line for p11tool usage. */
#define zUsageTitle     (p11tool_opt_strs+3151)
...
#define zBugsAddr       (p11tool_opt_strs+3246)
/** Clarification/explanation of what p11tool does. */
#define zExplain        (p11tool_opt_strs+3266)
/** Extra detail explaining what p11tool does. */
#define zDetail         (p11tool_opt_strs+3268)
/** The full version string for p11tool. */
#define zFullVersion    (p11tool_opt_strs+3678)
...
#define p11tool_short_usage (p11tool_opt_strs+3696)
