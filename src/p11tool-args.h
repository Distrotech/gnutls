 ...
 *
 *  It has been AutoGen-ed  January 12, 2014 at 02:07:42 PM by AutoGen 5.18.1
...
typedef enum {
    ...
    INDEX_OPT_LIST_ALL_TRUSTED   = 10,
    INDEX_OPT_INITIALIZE         = 11,
    INDEX_OPT_WRITE              = 12,
    INDEX_OPT_DELETE             = 13,
    INDEX_OPT_GENERATE_RANDOM    = 14,
    INDEX_OPT_GENERATE_RSA       = 15,
    INDEX_OPT_GENERATE_DSA       = 16,
    INDEX_OPT_GENERATE_ECC       = 17,
    INDEX_OPT_LABEL              = 18,
    INDEX_OPT_TRUSTED            = 19,
    INDEX_OPT_PRIVATE            = 20,
    INDEX_OPT_LOGIN              = 21,
    INDEX_OPT_DETAILED_URL       = 22,
    INDEX_OPT_SECRET_KEY         = 23,
    INDEX_OPT_LOAD_PRIVKEY       = 24,
    INDEX_OPT_LOAD_PUBKEY        = 25,
    INDEX_OPT_LOAD_CERTIFICATE   = 26,
    INDEX_OPT_PKCS8              = 27,
    INDEX_OPT_BITS               = 28,
    INDEX_OPT_SEC_PARAM          = 29,
    INDEX_OPT_INDER              = 30,
    INDEX_OPT_INRAW              = 31,
    INDEX_OPT_OUTDER             = 32,
    INDEX_OPT_OUTRAW             = 33,
    INDEX_OPT_PROVIDER           = 34,
...
#define VALUE_OPT_LIST_ALL_TRUSTED 0x100A
#define VALUE_OPT_INITIALIZE     0x100B
#define VALUE_OPT_WRITE          0x100C
#define VALUE_OPT_DELETE         0x100D
#define VALUE_OPT_GENERATE_RANDOM 0x100E

#define OPT_VALUE_GENERATE_RANDOM (DESC(GENERATE_RANDOM).optArg.argInt)
#define VALUE_OPT_GENERATE_RSA   0x100F
#define VALUE_OPT_GENERATE_DSA   0x1010
#define VALUE_OPT_GENERATE_ECC   0x1011
#define VALUE_OPT_LABEL          0x1012
#define VALUE_OPT_TRUSTED        0x1013
#define VALUE_OPT_PRIVATE        0x1014
#define VALUE_OPT_LOGIN          0x1015
#define VALUE_OPT_DETAILED_URL   0x1016
#define VALUE_OPT_SECRET_KEY     0x1017
#define VALUE_OPT_LOAD_PRIVKEY   0x1018
#define VALUE_OPT_LOAD_PUBKEY    0x1019
#define VALUE_OPT_LOAD_CERTIFICATE 0x101A
...
#define VALUE_OPT_INDER          0x101D
#define VALUE_OPT_INRAW          0x101E
#define VALUE_OPT_OUTDER         0x101F
#define VALUE_OPT_OUTRAW         0x1020
